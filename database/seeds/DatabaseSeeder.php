...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$panitia->agama = "islam";
		$panitia->alamat = "Jl. Haji Gedad Gang Kijon No.14 Paninggilan Utara, Sukoharjo";
    	...
    	foreach ($data_tahun_ajaran as $i=>$data) {
    		...
    		$tahunajaran -> created_at = '2022-01-05 20:30:0' . $i;
    		$tahunajaran -> save();
    	}
		...
		$jadwal_pendaftaran->tgl_mulai_pendf = "2021-12-15";
		$jadwal_pendaftaran->tgl_akhir_pendf = "2022-03-22";
		$jadwal_pendaftaran->tgl_mulai_tes = "2021-12-16";
		$jadwal_pendaftaran->tgl_akhir_tes = "2022-03-23";
		$jadwal_pendaftaran->tgl_hasil_seleksi = "2022-03-30";

...
class PendaftaranController extends Controller
{
    ...
    public function update(Request $req){
        ...
        $calonsiswa->matematika = $req->matematika;
        $calonsiswa->ipa = $req->ipa;
        $calonsiswa->bhs_indonesia = $req->bhs_indonesia;
        $calonsiswa->bhs_inggris = $req->bhs_inggris;

...
class TesSeleksiAkademikController extends Controller
{
    ...
    public function index(){
        ...
        return view('pages.admin.tesseleksi.index', compact('jadwal','tahunajarans','tesseleksis','admin'));
    }
    ...
    public function postIndex(Request $req){
        ...
        $admin = Auth::user()->username;
    	return view('pages.admin.tesseleksi.index', compact('jadwal','tahunajarans','belum_input_nilais','sudah_input_nilais','admin'));
    }
    ...
    public function paginatePostIndex(){
        ...
        $sudah_input_nilais->withPath('paginate/index');
        $admin = Auth::user()->username;
    	return view('pages.admin.tesseleksi.index', compact('tahunajarans','belum_input_nilais','sudah_input_nilais','admin'));
    }
}
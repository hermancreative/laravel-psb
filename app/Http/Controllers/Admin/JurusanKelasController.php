...
class JurusanKelasController extends Controller
{
    ...
    public function index(){
        ...
        // var_dump($admin);dd();
    	return view('pages.admin.jurusankelas.index', compact('tahunajarans','jurusans','kelas','tahunajaran','admin'));
    }
    ...
    public function indexKelas($kd_kelas){
        ...
        $admin = Auth::user()->username;
        return view('pages.admin.jurusankelas.index_kelas', compact('tahunajarans','kelas','admin'));
    }
    ...
    public function detailSiswa($no_pendf){
        ...
        $admin = Auth::user()->username;
        return view('pages.admin.jurusankelas.detail_siswa',compact('siswa','admin'));
    }
    ...
    public function editSiswa($id){
        ...
        $admin = Auth::user()->username;
        return view('pages.admin.jurusankelas.edit_siswa', compact('jurusans','siswa','admin'));
    }

...
class SoalController extends Controller
{
    ...
    public function index(){
    	...
    	return view('pages.admin.tesseleksi.soal.index', compact('soals','admin'));
    }
    ...
    public function edit($id_pertanyaan){
        ...
        $admin = Auth::user()->username;
        return view('pages.admin.tesseleksi.soal.edit', compact('soal','admin'));
    }
    ...
    public function detail($id_pertanyaan){
        $soal = Pertanyaan::find($id_pertanyaan);
        $admin = Auth::user()->username;
        return view('pages.admin.tesseleksi.soal.detail', compact('soal','admin'));
    }

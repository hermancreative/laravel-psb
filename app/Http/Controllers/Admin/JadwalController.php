...
class JadwalController extends Controller
{
    ...
    public function index(){
    	...
    	return view('pages.admin.jadwal.index', compact('tahunajarans','jadwals','admin'));
    }

    public function add(){
    	$tahunajarans = TahunAjaran::all();
		$admin = Auth::user()->username;
		return view('pages.admin.jadwal.add', compact('tahunajarans','admin'));
    }
    ...
    public function edit($id){
		...
		$admin = Auth::user()->username;
    	return view('pages.admin.jadwal.edit', compact('tahunajarans','jadwal','admin'));
    }
    ...
    public function detail($id){
    	$jadwal = JadwalPendaftaran::find($id);
		$admin = Auth::user()->username;
    	return view('pages.admin.jadwal.detail', compact('jadwal','admin'));
    }

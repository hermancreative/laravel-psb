...
class PendaftaranController extends Controller
{
    ...
    public function index($id_jadwal = null){
        ...
        $calonsiswas = CalonSiswa::where('id_jadwal',$idJadwal)->paginate(20);
        //var_dump(json_encode($calonsiswas));die();
        $paginates = count($calonsiswas);
        return view('pages.admin.pendaftaran.index', compact('tahunajarans','jadwals','jadwal','calonsiswas','paginates','admin'));
    }
    ...
    public function edit($id){
        ...
        $admin = Auth::user()->username;
        return view('pages.admin.pendaftaran.edit', compact('jurusans','calonsiswa','admin'));
    }
    ...
    public function detail($id){
        ...
        $calonsiswa = CalonSiswa::find($id);
        $admin = Auth::user()->username;
        return view('pages.admin.pendaftaran.detail', compact('jurusans','calonsiswa','admin'));
    }

...
class LandingController extends Controller
{
    ...
    public function postPendaftaran(Request $req){
            ...
            $calonsiswa->matematika = 0;
            $calonsiswa->ipa = 0;
            $calonsiswa->bhs_indonesia = 0;
            $calonsiswa->bhs_inggris = 0;
            $calonsiswa->doc_url = "";
            $calonsiswa->save();
            ...
            $steps->save();
            $pesan = 'Pendaftaran anda sukses silahkan login untuk melanjutkan pendaftaran';
            // flash('Message')->success('Pendaftaran anda sukses silahkan login untuk melanjutkan pendaftaran');
            // Session::flash('message', 'Pendaftaran anda sukses silahkan login untuk melanjutkan pendaftaran'); 

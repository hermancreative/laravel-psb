...
class CalonSiswa extends Model
{
    ...
    protected $fillable = ['no_pendf','id_user','kd_jurusan','id_jadwal','kd_kelas','nm_cln_siswa','nisn','jns_kelamin','tmp_lahir','tgl_lahir','agama','alamat','matematika','ipa','bhs_indonesia','bhs_inggris','nm_ortu','pkrj_ortu','gaji_ortu','sklh_asal','doc_url'];
